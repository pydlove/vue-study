		...
		<div class="observationData">
			<div>
				...
				<div class="dffn-ac mt-20">
					...
					<el-input class="ds-date" :placeholder="$t('message.inputObsTarge')" v-model="form.observationTarget"></el-input>
				</div>
				...
				<div class="dffn-ac mt-20">
					...
					<el-input class="ds-date" :placeholder="$t('message.inputObsWaveLength')" v-model="form.band"></el-input>
				</div>
    ...
    export default {
        ...
        methods: {
            ...
            async search(currentPage, pageSize) {
                ...
                let params = new FormData();
                if (this.form.observationTime != null && this.form.observationTime.length > 0) {
                    let beginTime = new Date(this.form.observationTime[0]);
                    let endTime = new Date(this.form.observationTime[1]);
