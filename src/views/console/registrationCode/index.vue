        ...
        <el-card :class="bgClass + '-card'" :style="'height:' + clientHeight + 'px;'">
            <el-card>
                ...
                >
                    ...
                    <el-table-column prop="code" label="注册码" :show-overflow-tooltip="true" align="center"></el-table-column>
                    <el-table-column prop="createTime" label="创建时间" :show-overflow-tooltip="true" align="center"></el-table-column>
                    <el-table-column prop="username" label="注册用户" :show-overflow-tooltip="true" align="center"></el-table-column>
                    <el-table-column prop="status" label="状态" fixed="right" align="center">
                        <template slot-scope="scope">
                            <el-tag class="wd-80" :type="scope.row.status == '0' ? 'success':'info'" effect="dark">
