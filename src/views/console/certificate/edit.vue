            ...
            <el-card class="auto-card wdi-800">
                <el-form
                    ...
                    <el-form-item label="证书唯一序列号" prop="uuid">
                        <el-input class="wdi-600" disabled v-model="form.uuid" placeholder="请生成证书唯一序列号"></el-input>
                    </el-form-item>
...
<script>
    export default {
        ...
        methods: {
            ...
            async submitRequest() {
                let data = await this.$aiorequest(this.$aiocUrl.console_service_v1_bl_certificate_edit, this.form, "POST");
                if(data.code == 200) {
                    if(this.fileName != this.originalFileName) {
