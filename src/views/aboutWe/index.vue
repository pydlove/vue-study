                ...
                <div class="aiocloud-card aw-left" >
                    <div class="nd-contact">
                        <div v-if="language == 'zh'">
                            <div class="nd-address">{{ $t('message.Address') }}: {{this.form.address}} </div>
                            <div class="nd-address">{{ $t('message.Contact') }}: {{this.form.tel}}</div>
                            <div class="nd-address">{{ $t('menu.footEmail') }}: {{this.form.email}}</div>
                        </div>
                        <div v-else-if="language == 'en'">
                            <div class="nd-address">{{ $t('message.Address') }}: {{this.form.enAddress}} </div>
                            <div class="nd-address">{{ $t('message.Contact') }}: {{this.form.tel}}</div>
                            <div class="nd-address">{{ $t('menu.footEmail') }}: {{this.form.email}}</div>
                        </div>
                    </div>
