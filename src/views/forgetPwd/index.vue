        ...
        <div class="lgrc">
            ...
            <div class="gnc wow bounceInRight">
                <div class="gnm">
                    ...
                    <el-form class="rform" label-width="80px" :model="registerForm">
                        <div class="rsr">
                            <span class="phone-icon"></span>
                            <el-input class="srin" v-model="registerForm.name" placeholder="请输入手机号"></el-input>
                        </div>

                        <div class="rsr">
                            <span class="code-icon"></span>
                            <el-input class="srin vcf" v-model="registerForm.verificationCode" placeholder="请输入4位短信验证码"></el-input>
                            <el-button class="hqyzm" disabled>获取验证码</el-button>
                        </div>

                        <div class="rsr">
                            <span class="code-icon"></span>
                            <el-input class="srin" v-model="registerForm.password" placeholder="请输入6-16位字母、数字、下划线组合的新密码"></el-input>
                        </div>

                        <div class="rsr">
                            <span class="code-icon"></span>
                            <el-input class="srin" v-model="registerForm.password" placeholder="请再次输入新密码"></el-input>
                        </div>

                        <el-button class="dl-btn" type="primary">立即保存</el-button>
                    </el-form>
