<template>
    <div>
        <el-dialog class="aiCloud-dialog"
                   ...
                   :show-close="false">
            <div>
                <el-form ref="form" :model="form" label-width="80px" :inline="inline" :label-position="labelPosition" >
                    ...
                    <div v-if="stage == 3">
                        <div>
                            ...
                            <el-card class="tr mt-10 mb-10">
                                订单费用合计：<span class="fs-20 color-fa5c26 fb">¥ {{50*form.subjectList.length + 10*commodityIds.length}}</span> 元
                            </el-card>
                            <el-card>
                                <div class="zfd">
                                    选择您的支付方式
